...
<body class="app sidebar-mini rtl">
	...
	<div class="app-title">
		<div>
			<h1>
				<i class="fa fa-dashboard"></i> Venta
			</h1>
		</div>
									...
									<div class="media">
										<div class="media-body text-xs-left">
											...
											<span><a style="color: black"
												href="/sysplat/Productos"> Productos </a></span>
										</div>
							...
							<div class="card-body">
								<div class="card-block">
									<div class="media">
										<div class="media-body text-xs-left">
											<h3 class="teal">15</h3>
											<span><a style="color: black" href="/sysplat/Clientes">
													Clientes </a></span>
										</div>
										<div class="media-right media-middle">
								...
								<div class="card-block">
									<div class="media">
										<div class="media-body text-xs-left">
											...
											<span><a style="color: black" href="/sysplat/Lista-Venta">
													Venta </a></span>
										</div>
										<div class="media-right media-middle">
											<i
